...
export async function POST(request) {
  ...
  try {
    console.log('[WAITLIST] Parsing request body');
    ...
    console.log('[WAITLIST] Generated referral code:', referralCode);
    ...
    console.log('[WAITLIST] Sending to Supabase...');
    ...
    console.log('[WAITLIST] Supabase response status:', insertResponse.status);
